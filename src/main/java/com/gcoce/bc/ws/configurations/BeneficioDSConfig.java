...
@EnableJpaRepositories(entityManagerFactoryRef = "beneficioEntityManagerFactory", transactionManagerRef = "beneficioTransactionManager", basePackages = {"com.gcoce.bc.ws.repositories.beneficio"})
public class BeneficioDSConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.gcoce.bc.ws.entities.beneficio");
